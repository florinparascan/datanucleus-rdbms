 ...
 */
public class DecimalColumnMapping extends AbstractColumnMapping
{
    private static final int INT_MAX_DECIMAL_DIGITS = 10;
    private static final int LONG_MAX_DECIMAL_DIGITS = 19;

    public DecimalColumnMapping(JavaTypeMapping mapping, RDBMSStoreManager storeMgr, Column col)
    {
